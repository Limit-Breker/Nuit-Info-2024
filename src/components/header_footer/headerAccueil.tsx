...
const HeaderAccueil: React.FC<HeaderProps> = ({ }) => {
    ...
    return (
        <header className="bg-none md:backdrop-blur p-4 md:p-6 flex flex-col md:flex-row justify-start md:gap-x-16 gap-0 items-center md:items-start px-4 md:px-16 fixed top-0 md:gap-y-0 gap-y-4 left-0 w-full md:h-auto h-full z-50">
            ...
            <div className={`flex-col md:flex-row md:h-auto h-full w-full md:w-auto items-center justify-center gap-y-4 md:gap-y-0 gap-x-4 md:gap-x-16 ${isMenuOpen ? 'flex' : 'hidden'} md:flex`}>
                <div className="flex flex-col md:flex-row w-full md:w-auto flex-wrap items-center justify-center gap-x-2 md:gap-x-5 bg-light-gray/40 backdrop-blur md:backdrop-blur-none px-3 md:px-5 py-2.5 md:py-2 rounded-jb md:h-auto h-full gap-y-4 md:gap-y-0">
            ...
            <div className={`mt-4 md:ml-auto md:mt-0 md:flex ${isMenuOpen ? 'flex' : 'hidden'} justify-center md:justify-end w-full md:w-auto`}>
