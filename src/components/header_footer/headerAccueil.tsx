...
const HeaderAccueil: React.FC<HeaderProps> = ({ }) => {
    ...
    return (
        <header className="bg-none backdrop-blur p-4 md:p-6 flex flex-col md:flex-row justify-between items-center md:items-start px-4 md:px-16 fixed top-0 left-0 w-full z-50">
            ...
            <div className={`flex-col md:flex-row items-center justify-center gap-y-4 md:gap-y-0 gap-x-4 md:gap-x-16 ${isMenuOpen ? 'flex' : 'hidden'} md:flex`}>
                <div className="flex flex-wrap items-center justify-center gap-x-2 md:gap-x-5 bg-light-gray/40 px-3 md:px-5 py-2 rounded-jb">
